            ...
            <form @submit.prevent="onSubmit" class="needs-validation icons-form row" novalidate>
                        ...
                        <div class="form-group  col-12">
                           <select class="form-control" name="regulation" v-model="league.regulation" placeholder="...نوع التنظيم">
                                ...
                                <option value="types">أدوار</option>
                           </select>
                            <div class="invalid-feedback">
                         ...
                         <div class="form-group  col-12" v-if="league.regulation == 'groups'">
                        ...
                        <div class="form-group  col-12" v-if="league.regulation == 'types'">
...
export default  {
  ...
  mounted(){
    ...
    this.league.photo = '';
    this.league.league_id = this.league.id;
  ...
  methods: {
        ...
        setSuccessMessage() {
            ...
            this.$dialogs.alert('تم التعديل على الدورى بنجاح', options)
            .then(res => {
