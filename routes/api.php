...
Route::post('/deleteadmin/{id}', 'AdminsController@destroy');
Route::get('/getownerstadiums', 'UsersController@getOwnerStadiums');
Route::get('/getteamowners', 'UsersController@getTeamOwners');
Route::get('/getplayers', 'UsersController@getPlayers');
Route::get('/getrefrees', 'UsersController@getRefrees');
...
Route::get('/getwidgets', 'WidgetsController@getWidgets');
Route::post('/add_or_update_widget', 'WidgetsController@store');
Route::post('/updatesettings/1', 'SettingsController@store');
